...
const ProductDetails = forwardRef(({ editproductDetails, CategoryOptions, productoption, handleproductChange, locationdata }, ref) => {
  ...
  // Update filteredCategories when ProductName changes
  const handleProductNameChange = (value) => {
    handleproductChange(value);

    // Example filtering logic: filter categories based on product name
    const updatedCategories = CategoryOptions.filter((category) => {
      return category.relatedProducts.includes(value); // Assuming 'relatedProducts' is part of category data
    });
